...
const gradientColors: Record<ColorVariant, GradientColors> = {
  ...
  blue: {
    dark: {
      border: "from-[#2B6CB0] via-[#0C1F21] to-[#2C5282]",
      overlay: "from-[#3182CE]/40 via-[#0C1F21] to-[#2B6CB0]/30",
      accent: "from-[#BEE3F8]/10 via-[#0C1F21] to-[#2C5282]/50",
      text: "from-[#BEE3F8] to-[#90CDF4]",
      glow: "rgba(66,153,225,0.1)",
      textGlow: "rgba(66,153,225,0.4)",
      hover: "from-[#2C5282]/20 via-[#63B3ED]/10 to-[#2C5282]/20",
    },
    light: {
